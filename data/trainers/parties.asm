...
ProfOakData:
; Unused
	db $FF, 66, CHANSEY, 67, TAUROS, 68, SNORLAX, 69, BLASTOISE, 70, VENUSAUR, 70, CHARIZARD, 0
...
; Viridian Gym
	db $FF, 52, DUGTRIO, 51, TAUROS, 54, NIDOQUEEN, 54, NIDOKING, 60, RHYDON, 0
...
BrunoData:
	db $FF, 57, POLIWRATH, 59, HITMONCHAN, 59, HITMONLEE, 60, GOLEM, 62, MACHAMP, 0

BrockData:
	db $FF, 11, KABUTO, 11, OMANYTE, 14, ONIX, 0

MistyData:
	db $FF, 18, PSYDUCK, 20, HORSEA, 22, STARMIE, 0

LtSurgeData:
	db $FF, 23, VOLTORB, 25, MAGNEMITE, 24, PORYGON, 27, RAICHU, 0

ErikaData:
	db $FF, 32, WEEPINBELL, 34, TANGELA, 33, BUTTERFREE, 35, VILEPLUME, 0

KogaData:
	db $FF, 36, GOLBAT, 34, WEEZING, 38, SCYTHER, 40, MUK, 0

BlaineData:
	db $FF, 53, NINETALES, 52, RAPIDASH, 54, ARCANINE, 56, MAGMAR,

SabrinaData:
	db $FF, 45, MR_MIME, 48, EXEGGUTOR, 47, VENOMOTH, 50, ALAKAZAM, 0
...
Rival3Data:
; Champion's Room
	db $FF, 64, DODRIO, 62, ALAKAZAM, 66, RHYDON, 63, KINGLER, 67, JOLTEON, 68, CHARIZARD, 0
	db $FF, 64, DODRIO, 62, ALAKAZAM, 66, RHYDON, 63, ELECTABUZZ, 67, FLAREON, 68, BLASTOISE, 0
	db $FF, 64, DODRIO, 62, ALAKAZAM, 66, RHYDON, 63, MAGMAR, 67, VAPOREON, 68, VENUSAUR, 0

LoreleiData:
	db $FF, 57, DEWGONG, 55, CLOYSTER, 56, VAPOREON, 58, JYNX, 60, LAPRAS, 0
...
AgathaData:
	db $FF, 60, ARBOK, 61, NINETALES, 63, PARASECT, 63, MAROWAK, 64, GENGAR, 0

LanceData:
	db $FF, 62, GYARADOS, 65, DRAGONAIR, 63, ARCANINE, 61, AERODACTYL, 66, DRAGONITE, 0
